    ...
    describe "pagination" do
      ...
      describe "as an admin user" do
        ...
        describe "other users should have an unlock link" do  ## changed the description
          let!(:user) { FactoryGirl.create(:locked) }
          before do
            visit users_path
            click_link "2"
            # save_and_open_page
          ...
          # it { save_and_open_page; should have_link('unlock', href: user_path(locked_user)) }
          # it { binding.pry; should have_link('unlock', href: user_path(locked_user)) }
          it { should have_link('unlock', href: unlock_user_path(user)) }
        end
      end
